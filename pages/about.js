...
class About extends React.Component {
  ...
  render() {
    return (
      <BaseLayout title='Tinh Phan - Learn More About Me' {...this.props.auth}>
          ...
          <Row className="mt-5">
            ...
            <Col md="6">
              <div className="fadein">
                <p>My name is Tinh and I am an experienced web developer and freelancer. </p>
                <p>
                ...
                <p>
                  My Github: <a target="_blank" href="https://github.com/FunctorGuys">FunctorGuys</a>
                </p>
                <p>
                  Contact me at{" "}
                  <a target="_blank" href="mailto:functor.guys@gmail.com">functor.guys@gmail.com</a>
                </p>
              </div>
            </Col>
          </Row>
